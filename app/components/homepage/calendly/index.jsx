...
export default function Calendly(){
    ...
    return (
        <motion.div 
            id="calendly" 
            className="relative z-50 my-0.5 lg:my-2 pt-2 scroll-mt-6"
            initial="hidden"
            whileInView="visible"
        ...
        >  
                            ...
                            >
                                ...
                                >
                                    <FontAwesomeIcon 
                                        ...
                                        className="mr-2 !hidden sm:!inline-block" fade/>Book time to meet with me!
                                </motion.span>
                            </motion.div>
                        </motion.div>
                    </div>
            ...
            <motion.div className="flex justify-center w-full my-4" variants={calendarVariants}>
                <InlineWidget
                    url={`https://calendly.com/${personalData.calendly}/30min?hide_gdpr_banner=1&text_color=4995ff"`}
