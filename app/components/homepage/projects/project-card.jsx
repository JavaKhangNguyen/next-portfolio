      ...
      <div className="overflow-hidden border-t-[2px] border-indigo-900 pl-4 lg:pl-8 py-4 lg:py-8">
        <code className="font-sans text-xs md:text-sm lg:text-base">
          ...
          <div>
            ...
            <span className="text-gray-400">{`'`}</span>
            <span className="text-amber-400">{project.role}</span>
            <span className="text-gray-400">{`'`}</span>
            <span className="text-gray-400">,</span>
          </div>
          <div className="ml-4 lg:ml-8 mr-2">
            <span className="text-white">projectInfo:</span>
            <span className="text-amber-400">{` '`}</span>
            <span className="text-amber-400">{project.description}</span>
            <span className="text-gray-400">{`'`}</span>
          </div>
          <div className="ml-4 lg:ml-8 mr-2">
            <span className="text-white">URL:</span>
            <span className="text-amber-400">{` '`}</span>
            <span className="text-amber-400">Click on card header to view</span>
            <span className="text-gray-400">{`'`}</span>
          </div>
